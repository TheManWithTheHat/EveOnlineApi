...
/**
 * MapCelestialStatistic Model
 *
 */
class MapCelestialStatistic extends EveOnlineApiAppModel {
/**
 * Use database config
 *
 * @var string
 ...
 */
	public $useTable = 'mapCelestialStatistics';
/**
 * Primary key field
 *
 * @var string
 */
	public $primaryKey = 'celestialID';
}
